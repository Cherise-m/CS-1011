...
public class District {
    ...
    private int totalTimeClosed, previousTime, total;
    ...
    public int getNumberOfSpotsRemaining() {
        spotsOpen = (lot1.getNumberOfSpotsRemaining()
    ...
    public void markVehicleExit(int lotNumber, int timestamp) {
        ...
        if (previousTime <= timestamp) {
            if (lotNumber == 1) {
                lot1.markVehicleExit(timeOpened);
            } else if (lotNumber == 2) {
                lot2.markVehicleExit(timeOpened);
            } else if (lotNumber == 3) {
                lot3.markVehicleExit(timeOpened);
            }
            timeOpened = timestamp;
